...
const urls = ['/dashboard', '/profile', '/checkout', '/home', '/settings', '/api/users', '/products', '/cart', '/search', '/about'];
const types = ['page_view', 'click', 'error', 'api_call'] as const;
...
export async function POST(_req: NextRequest) {
  ...
  try {
    ...
    await Event.deleteMany({ user_id: userId, 'metadata.source': { $ne: 'website_analyzer' } });
